...
SECRET_KEY = 'django-insecure-%hyc_=+3=52^%byc7czk_%adk%nv--=a(yae03qukm9l3-b1=h'
...
# Configuración dinámica de la base de datos según la variable de entorno IS_SQLITE
if os.environ.get('IS_SQLITE'):
    DATABASES = {
        'default': {
